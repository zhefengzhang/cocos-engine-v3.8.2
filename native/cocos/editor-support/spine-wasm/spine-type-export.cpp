...
EMSCRIPTEN_BINDINGS(spine) {
    ...
    class_<SpineModel>("SpineModel")
        ...
        .function("getAttachedSlotName", &SpineModel::getAttachedSlotName, allow_raw_pointer<std::vector<std::string>>())
    ...
    class_<SpineSkeletonInstance>("SkeletonInstance")
        ...
        .function("getAttachedSlotNames", &SpineSkeletonInstance::getAttachedSlotNames, allow_raw_pointers())
        .function("setAttachedSlotNames", &SpineSkeletonInstance::setAttachedSlotNames)
